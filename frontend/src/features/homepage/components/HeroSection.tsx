...
const styles = {
  section: 'relative min-h-[600px] flex items-center justify-center overflow-hidden',
  ...
  subtitle: 'mt-4 text-xl text-white/90 max-w-2xl mx-auto',
  cta: 'mt-8 flex justify-center gap-4',
}
...
export function HeroSection() {
  ...
  return (
    <section aria-label={t('homepage.hero.title')} className={styles.section}>
      <img src={getAssetUrl(SITE_CONFIG.assets.heroImage)} alt="" aria-hidden="true" className={styles.image} />
      ...
      <div className={styles.content}>
        ...
        <div className={styles.cta}>
          <Link to={`${prefix}/get-a-quote` as never}>
            <Button variant="default" size="lg">{t('nav.getQuote')}</Button>
          </Link>
